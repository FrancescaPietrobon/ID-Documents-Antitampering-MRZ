...
std::pair<matrix2D, std::vector<float>> AntitamperingMrzDBSCAN::predictFromModel(Document & document, std::string networkPath, int numClasses, float thresholdIOU, float thresholdNMS)
{
    // Predict
